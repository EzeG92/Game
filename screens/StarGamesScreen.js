            ...
            <View style={styles.screen}>
                <Card>
                    ...
                    <View style={styles.buttonContainer}>
                        ...
                        <Pressable
                            style={{ ...styles.cleanButton, backgroundColor: Colors.secondary, width: 80, }}
                ...
                {confirmed && (
                    <Card newStyles={{ marginTop: 50, width: 160,}}>
                        <Text style={styles.text}>Tu numero</Text>
                        <Text style={styles.text}>{selectedNumber}</Text>
                        <Pressable
                            style={{ ...styles.cleanButton, backgroundColor: Colors.secondary, width: 120, marginTop: 20,}}
